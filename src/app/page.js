...
const features = [
  { href: '/marketplace', icon: '🛒', title: 'Student Marketplace', desc: 'Buy, sell, rent, donate or exchange books, electronics, lab equipment & more with verified VIT students.', color: '#6366f1' },
  { href: '/notes', icon: '📚', title: 'Notes & PYQ Repository', desc: 'Access and share class notes, previous year papers, and study materials organized by branch and semester.', color: '#3b82f6' },
  { href: '/assignments', icon: '📝', title: 'Assignment Repository', desc: 'Find and share solved assignments, lab manuals, and project reports from your department.', color: '#8b5cf6' },
  { href: '/requests', icon: '📋', title: 'Resource Request Board', desc: 'Post requests for specific resources and let the community help you find what you need.', color: '#10b981' },
  { href: '/ai-assistant', icon: '🤖', title: 'AI Academic Assistant', desc: 'Get instant help with academics — powered by Gemini AI, trained to assist VIT students.', color: '#f59e0b' },
  { href: '/chat', icon: '💬', title: 'Student Chat', desc: 'Connect with fellow VIT students in real-time. Discuss courses, share tips, and build your network.', color: '#ef4444' },
  { href: '/tools', icon: '🛠️', title: 'Academic Tools', desc: 'GPA calculator, attendance tracker, timetable builder, and deadline tracker — all in one place.', color: '#06b6d4' },
];
          ...
          <div className="grid grid-3 stagger-children">
            {features.map(f => (
              <Link key={f.href} href={f.href} className="card-glass card-interactive" style={{ textDecoration: 'none', color: 'inherit', padding: 'var(--space-8)' }}>
                <div style={{ width: 56, height: 56, borderRadius: 'var(--radius-lg)', background: `${f.color}20`, color: f.color, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', marginBottom: 'var(--space-4)' }}>
                  {f.icon}
                </div>
